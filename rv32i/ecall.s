# Test for the ECALL (Environment Call) instruction.
...
_start:
    ...
    # The exact behavior (e.g., system call handling) depends on the environment.

    # Initialize a register to indicate test status.
    # We will change this to 1 only if the ECALL executes without trapping
    # as an illegal instruction and allows program continuation.
    ...
    # If we reached here, the ECALL instruction was decoded and handled
