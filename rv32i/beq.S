# Test for the BEQ (Branch if Equal) instruction.
...
_start:
    ...
    # Test case 1: Branch taken (10 == 10)
    li      a0,     10
    li      a1,     10
    beq     a0,     a1,     pass_1
    j       test_fail
...
pass_1:
    # Test case 2: Branch not taken (10 != 5)
    li      a0,     10
    li      a1,     5
    beq     a0,     a1,     test_fail
    j       pass_2
...
pass_3:
    # Test case 4: Branch not taken (-5 != 5)
    li      a0,     -5
    li      a1,     5
    beq     a0,     a1,     test_fail
    j       all_tests_passed
