# Test for the BGE (Branch if Greater than or Equal) instruction.
...
pass_4:
    # Test case 5: Branch not taken (-10 >= -5)
    li      a0,     -10
    li      a1,     -5
    bge     a0,     a1,     test_fail
    j       pass_5
...
pass_6:
    # Test case 7: Branch not taken (-5 >= 5)
    li      a0,     -5
    li      a1,     5
    bge     a0,     a1,     test_fail
    j       all_tests_passed
